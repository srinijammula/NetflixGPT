...
return(
    ...
    <form className="p-12 bg-black bg-opacity-75 text-white absolute w-1/3 top-24 mx-auto right-0 left-0">
        ...
        <input type="email" placeholder="Email or phone number" className="p-3 m-3 w-full rounded-md bg-gray-700"/>
        <input type="password" placeholder="Password" className="p-3 m-3 w-full rounded-md bg-gray-700"/>
        <button type="submit" className="p-3 m-3 bg-red-600 w-full rounded-md">{isSignInForm ? "Sign In" : "Sign Up"}</button>
