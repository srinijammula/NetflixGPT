...
const GptSearchBar = () =>{
    ...
    return(
        <div className="pt-52 md:pt-20 flex justify-center">
            <form className="w-full m-1 md:w-1/2 bg-black rounded-lg p-2 grid grid-cols-12" onSubmit={(e) => e.preventDefault()}>
